<template>
    <div class="main-nav">
        <nav class="navbar navbar-expand-md navbar-dark bg-dark">
            ...
            <router-link class="navbar-brand" to="/"><icon :icon="['fab', 'microsoft']"/> Simple Survey</router-link>
            ...
            <transition name="slide">
                <div :class="'collapse navbar-collapse' + (!collapsed ? ' show':'')" v-show="!collapsed">
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item"><a href="/Home/Logout"><i class="glyphicon glyphicon-play"></i>Logout</a></li>
                    </ul>
                </div>
            </transition>
        </nav>
